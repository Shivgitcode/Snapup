...
export default function About() {
    return (
        <div className=" px-[16px] mx-[17px] py-[40px]">
            <div className="flex flex-col items-center">
                <h1 className=" mt-[8px] text-[30px] font-bold leading-[36px]">What Uptime Monitor can do?</h1>
                <p className=" text-center mt-[20px] text-[20px] leading-[28px] text-[#6b7280]">
            ...
            <div className="flex flex-col items-center mt-[24px] gap-6">
                {about.map(el => {
                    return (
